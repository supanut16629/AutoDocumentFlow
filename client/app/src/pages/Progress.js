    ...
    async function fetchDocumentProgress() {
      try {
        ...
        if (status === "ok") {
          ...
          console.log("list DocProgress :",newDocProgress)
      ...
      <div className="flex-cl pdr1 pdl1">
        ...
        <div className="table">
          ...
          {docProgress.map((doc, index) => {
            // const dateLastTime = doc.lastTime_Edit //Ex. 2024-03-20T11:15:56.000+00:00
            ...
            const formattedDateCreate = dateCreate.toLocaleString("th-TH", options);
